...
global $post;
?>
<div class="lp-widget-recent-courses archive-course-widget-outer <?php echo esc_attr( $instance['css_class'] ); ?>">
	<div class="lp-widget-recent-courses__content widget-body">
