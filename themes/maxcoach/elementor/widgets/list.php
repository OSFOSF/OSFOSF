...
class Widget_List extends Base {
	...
	private function add_list_section() {
		...
		$this->add_control( 'style', [
			...
			'options'      => [
				...
				'icon-border' => esc_html__( 'Icon Circle Border', 'maxcoach' ),
				'icon-fill'   => esc_html__( 'Icon Circle Fill', 'maxcoach' ),
		...
		$this->add_control( 'separator_style', [
			...
			'options'      => [
				...
				'01' => esc_html__( 'Vertical line', 'maxcoach' ),
			],
			'prefix_class' => 'maxcoach-list-separator-',
		] );
	...
	private function add_icon_style_section() {
		...
		$this->add_control( 'hover_icon_marker_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .link:hover' => '--icon-mark-color: {{VALUE}};',
			],
			'condition' => [
				'style' => [
					'icon-border',
