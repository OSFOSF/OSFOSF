...
class Widget_Testimonial_Carousel extends Static_Carousel {
	...
	private function add_content_style_section() {
		...
		$this->add_control( 'star_heading', [
			'label'     => esc_html__( 'Star Rating', 'maxcoach' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
	...
	private function add_image_style_section() {
		...
		$this->add_control( 'image_flex_height', [
			'label'     => esc_html__( 'Flex Height', 'maxcoach' ),
			'type'      => Controls_Manager::SWITCHER,
			'label_on'  => esc_html__( 'Yes', 'maxcoach' ),
			'label_off' => esc_html__( 'No', 'maxcoach' ),
			'selectors' => [
				'{{WRAPPER}} .image img' => 'height: auto !important',
			],
		] );
	...
	private function print_testimonial_cite() {
		...
		if ( ! empty( $slide['rating'] ) && ! in_array( $settings['style'], [ '08', '11' ] ) ):
	...
	private function print_layout() {
		...
		<?php if ( $slide['content'] ) : ?>
			<div class="content">
				<?php if ( ! empty( $slide['rating'] ) && in_array( $settings['style'], [ '11' ] ) ) : ?>
					<?php echo $this->get_testimonial_rating_template( $slide['rating'], [ 'show_details' => false ] ); ?>
				<?php endif; ?>
