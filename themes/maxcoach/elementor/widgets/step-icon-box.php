...
class Widget_Step_Icon_Box extends Base {

	public function get_name() {
		return 'tm-step-icon-box';
	}

	public function get_title() {
		return esc_html__( 'Step Icon Box', 'maxcoach' );
	}
	...
	protected function register_controls() {
		...
		$this->add_badge_text_style_section();
	...
	private function add_icon_box_section() {
		...
		$this->add_control( 'style', [
			...
			'default'      => '01',
			'prefix_class' => 'maxcoach-step-icon-box-style-',
		] );
	...
	private function add_content_badge_text() {
		$this->add_control( 'badge_text_heading', [
			'label'     => esc_html__( 'Badge Text', 'maxcoach' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
	...
	private function add_icon_style_section() {
		...
		$this->add_group_control( Group_Control_Background::get_type(), [
			...
			'selector' => '{{WRAPPER}} .tm-step-icon-box:hover .maxcoach-icon-view',
		] );
	...
	private function add_badge_text_style_section() {
	...
	protected function render() {
		...
		$this->add_render_attribute( 'box', 'class', 'tm-step-icon-box maxcoach-box' );
	...
	protected function content_template() {
		...
		<#
		view.addRenderAttribute( 'box', 'class', 'tm-step-icon-box maxcoach-box' );
		var box_tag = 'div';
