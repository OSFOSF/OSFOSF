...
if ( ! class_exists( 'Maxcoach_Woo' ) ) {
	class Maxcoach_Woo extends Maxcoach_Post_Type {
		...
		public function define_constants() {
			define( 'MAXCOACH_WOO_DIR', get_template_directory() . DIRECTORY_SEPARATOR . 'woocommerce' );
			define( 'MAXCOACH_WOO_CORE_DIR', MAXCOACH_FRAMEWORK_DIR . DIRECTORY_SEPARATOR . 'woocommerce' );
		}
		...
		public function initialize() {
			...
			require_once MAXCOACH_WOO_CORE_DIR . '/compare.php';
		...
		function get_compare_button_template( $args = array() ) {
			if ( Maxcoach::setting( 'shop_archive_compare' ) !== '1' || wp_is_mobile() || ! class_exists( 'WPCleverWoosc' ) ) {
				return;
			}
